...
BUILDERS_PRESETS: dict[str, dict[str, Any]] = {
    ...
    # monolith.py - gothic coastal monolith kit for Sea Above
    "MEL_monolith_spire": {
        "label": "Monolith Spire",
        "preset_labels": {
            "COASTAL_FRAGMENT": "Coastal Fragment",
            "DEEP_GIANT": "Deep Giant",
            "MIRROR_TOWER": "Mirror Tower",
        },
        "preset_descriptions": {
            "COASTAL_FRAGMENT": "Default gothic coastal basalt spire — single fragment with tide pool and mirror inlay.",
            "DEEP_GIANT": "Taller, slimmer spire emerging from deeper water — implies vast submerged body.",
            "MIRROR_TOWER": "Heavily fractured mirror inlay — reads as a broken reflection portal.",
        },
        "presets": {
            "COASTAL_FRAGMENT": {"Base Width": 3.0, "Height": 12.0, "Taper": 0.32, "Fracture Count": 4, "Mirror Inlay": 0.18, "Tide Pool Depth": 0.45},
            "DEEP_GIANT": {"Base Width": 5.0, "Height": 35.0, "Taper": 0.18, "Fracture Count": 8, "Mirror Inlay": 0.05, "Tide Pool Depth": 2.0},
            "MIRROR_TOWER": {"Base Width": 2.5, "Height": 18.0, "Taper": 0.22, "Fracture Count": 16, "Mirror Inlay": 0.85, "Tide Pool Depth": 0.3},
        },
    },
    "MEL_monolith_field": {
        "label": "Monolith Field",
        "preset_labels": {
            "SHORELINE_SCATTER": "Shoreline Scatter",
            "DEEP_RUINS": "Deep Ruins",
            "MIRROR_FOREST": "Mirror Forest",
        },
        "preset_descriptions": {
            "SHORELINE_SCATTER": "Default monolith field — moderate density, natural height variation.",
            "DEEP_RUINS": "Dense field of tall spires — reads as a drowned civilization.",
            "MIRROR_FOREST": "Low, wide field with heavy mirror inlay — every surface reflects.",
        },
        "presets": {
            "SHORELINE_SCATTER": {"Field Width": 40.0, "Field Depth": 40.0, "Density": 16, "Height Variation": 0.6, "Seed": 3900},
            "DEEP_RUINS": {"Field Width": 80.0, "Field Depth": 80.0, "Density": 48, "Height Variation": 0.85, "Seed": 42},
            "MIRROR_FOREST": {"Field Width": 60.0, "Field Depth": 60.0, "Density": 32, "Height Variation": 0.3, "Seed": 7},
        },
    },
    "MEL_monolith_manta_silhouette": {
        "label": "Manta Silhouette",
        "preset_labels": {
            "PELAGIC_GHOST": "Pelagic Ghost",
            "BROKEN_WING": "Broken Wing",
            "TIDE_POOL_RAY": "Tide Pool Ray",
        },
        "preset_descriptions": {
            "PELAGIC_GHOST": "Default manta silhouette — vast wingspan, gentle curve, implied body beneath.",
            "BROKEN_WING": "Asymmetric wing — one side fractured, reads as a wounded leviathan.",
            "TIDE_POOL_RAY": "Small, tight curve — fits inside a single tide pool basin.",
        },
        "presets": {
            "PELAGIC_GHOST": {"Wingspan": 18.0, "Body Length": 6.0, "Wing Curve": 0.45, "Fin Detail": 32, "Subdivisions": 6},
            "BROKEN_WING": {"Wingspan": 24.0, "Body Length": 8.0, "Wing Curve": 0.7, "Fin Detail": 48, "Subdivisions": 8},
            "TIDE_POOL_RAY": {"Wingspan": 4.0, "Body Length": 1.5, "Wing Curve": 0.3, "Fin Detail": 16, "Subdivisions": 4},
        },
    },
    "MEL_monolith_tide_pool": {
        "label": "Tide Pool",
        "preset_labels": {
            "BASIN_REFLECTION": "Basin Reflection",
            "SHARD_STORM": "Shard Storm",
            "DEEP_ABYSS": "Deep Abyss",
        },
        "preset_descriptions": {
            "BASIN_REFLECTION": "Default tide pool — calm water, few mirror shards, pale ocean reflection.",
            "SHARD_STORM": "Broken mirror field — dozens of reflective shards, fractured sky.",
            "DEEP_ABYSS": "Deep basin with dark water — the reflection shows something vast moving below.",
        },
        "presets": {
            "BASIN_REFLECTION": {"Radius": 2.5, "Depth": 0.6, "Shard Count": 8, "Water Level": 0.7},
            "SHARD_STORM": {"Radius": 4.0, "Depth": 0.4, "Shard Count": 48, "Water Level": 0.5},
            "DEEP_ABYSS": {"Radius": 6.0, "Depth": 3.0, "Shard Count": 4, "Water Level": 0.85},
        },
    },
    "MEL_monolith_reflection_portal": {
        "label": "Reflection Portal",
        "preset_labels": {
            "GOTHIC_DOORWAY": "Gothic Doorway",
            "BROKEN_ARCH": "Broken Arch",
            "MIRROR_GATE": "Mirror Gate",
        },
        "preset_descriptions": {
            "GOTHIC_DOORWAY": "Default gothic pointed-arch portal — intact frame, pale ocean reflection.",
            "BROKEN_ARCH": "Fractured top — the arch is breaking apart, reflection distorts.",
            "MIRROR_GATE": "Wide, low portal — every surface is mirror, the ocean is everywhere.",
        },
        "presets": {
            "GOTHIC_DOORWAY": {"Width": 4.0, "Height": 7.0, "Arch Point": 0.35, "Frame Thickness": 0.35, "Broken Top": 0.0},
            "BROKEN_ARCH": {"Width": 5.0, "Height": 9.0, "Arch Point": 0.5, "Frame Thickness": 0.4, "Broken Top": 0.6},
            "MIRROR_GATE": {"Width": 8.0, "Height": 5.0, "Arch Point": 0.15, "Frame Thickness": 0.25, "Broken Top": 0.3},
        },
    },
