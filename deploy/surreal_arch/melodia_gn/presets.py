...
# Universal Wardrobe Studio kit (2026-09-06, Phase 2).
# Keys are exact interface sockets; all base-state dials 0 = neutral (proof G3).
BUILDERS_PRESETS["MEL_garm_drape_base"] = {
    "label": "Wardrobe Drape Base",
    "presets": {
        "Fitted_Bodice": {"Shell Offset": 0.012, "Skirt Flare": 0.0, "Torso Taper": -0.06, "Noise Life": 0.004, "Seed": 20260906},
        "A_Line_Gown": {"Shell Offset": 0.016, "Skirt Flare": 0.55, "Torso Taper": -0.02, "Noise Life": 0.008, "Seed": 20260906},
        "Opera_Cloak": {"Shell Offset": 0.030, "Skirt Flare": 1.1, "Torso Taper": 0.08, "Noise Life": 0.02, "Seed": 20260906},
    },
    "preset_labels": {
        "Fitted_Bodice": "Fitted Bodice", "A_Line_Gown": "A-Line Gown", "Opera_Cloak": "Opera Cloak",
    },
    "preset_descriptions": {
        "Fitted_Bodice": "Close-cut torso shell, minimal skirt.",
        "A_Line_Gown": "Classic flared silhouette from the waist.",
        "Opera_Cloak": "Heavy dramatic outer layer with surface life.",
    },
}

BUILDERS_PRESETS["MEL_garm_trim_lattice"] = {
    "label": "Wardrobe Trim Lattice",
    "presets": {
        "Delicate_Edge": {"Trim Density": 4.0, "Trim Size": 0.012, "Rivet Pitch Factor": 8.0, "Seed": 20260906},
        "Court_Brass": {"Trim Density": 9.0, "Trim Size": 0.02, "Rivet Pitch Factor": 6.0, "Seed": 20260906},
        "War_Regalia": {"Trim Density": 16.0, "Trim Size": 0.032, "Rivet Pitch Factor": 4.0, "Seed": 20260906},
    },
    "preset_labels": {
        "Delicate_Edge": "Delicate Edge", "Court_Brass": "Court Brass", "War_Regalia": "War Regalia",
    },
    "preset_descriptions": {
        "Delicate_Edge": "Sparse fine rivets, heirloom finish.",
        "Court_Brass": "Standard court lattice at canonical 6x pitch.",
        "War_Regalia": "Dense heavy rivets, battle dress.",
    },
}

BUILDERS_PRESETS["MEL_garm_layer_stack"] = {
    "label": "Wardrobe Layer Stack",
    "presets": {
        "Chemise_Slip": {"Layer Offset": 0.004, "Layer Count": 2.0},
        "Corsetry": {"Layer Offset": 0.008, "Layer Count": 3.0},
        "Winter_Cloak_Stack": {"Layer Offset": 0.014, "Layer Count": 4.0},
    },
    "preset_labels": {
        "Chemise_Slip": "Chemise + Slip", "Corsetry": "Corsetry", "Winter_Cloak_Stack": "Winter Cloak Stack",
    },
    "preset_descriptions": {
        "Chemise_Slip": "Two whisper-thin layers.",
        "Corsetry": "Three structured layers with visible gasket seams.",
        "Winter_Cloak_Stack": "Four heavy layers, deep gaskets.",
    },
}

BUILDERS_PRESETS["MEL_garm_chladni_layer"] = {
    "label": "Wardrobe Chladni Layer",
    "presets": {
        "Whisper_Silk": {"Eigen M": 2.0, "Eigen N": 3.0, "Cymatic Amplitude": 0.006, "Audio Gain": 1.2, "Low Hz": 40.0, "High Hz": 320.0, "Time": 0.0, "Seed": 20260906},
        "Resonant_Satin": {"Eigen M": 4.0, "Eigen N": 5.0, "Cymatic Amplitude": 0.014, "Audio Gain": 2.0, "Low Hz": 80.0, "High Hz": 640.0, "Time": 0.0, "Seed": 20260906},
        "Anthem_Velvet": {"Eigen M": 6.0, "Eigen N": 8.0, "Cymatic Amplitude": 0.028, "Audio Gain": 3.5, "Low Hz": 120.0, "High Hz": 1200.0, "Time": 0.0, "Seed": 20260906},
    },
    "preset_labels": {
        "Whisper_Silk": "Whisper Silk", "Resonant_Satin": "Resonant Satin", "Anthem_Velvet": "Anthem Velvet",
    },
    "preset_descriptions": {
        "Whisper_Silk": "Low mode pair, barely-there cymatics.",
        "Resonant_Satin": "Mid modes at (4,5) — classic plate figure.",
        "Anthem_Velvet": "High modes, deep amplitude — singing fabric.",
    },
}
