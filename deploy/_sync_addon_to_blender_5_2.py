...
# SSOT: sync always sources from BS_GodFile/deploy regardless of which copy runs.
SSOT = r"C:\EnvironmentPortfolio\BS_GodFile\deploy"
...
PACKAGES = {
    "surreal_arch": os.path.join(SSOT, "surreal_arch"),
    "surreal_os": os.path.join(SSOT, "surreal_os"),
    "surreal_world": os.path.join(SSOT, "surreal_world"),
    "surreal_greybox": os.path.join(SSOT, "surreal_greybox"),
}

MONOLITH_SRC = os.path.join(SSOT, "surreal_architecture_gen.py")
