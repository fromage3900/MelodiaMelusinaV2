...
> | Monolith mesh/Houdini gap analysis (all 14 monoliths) | **Done 2026-08-29 late** — `Docs/Art/MONOLITH_MESH_AND_HOUDINI_GAP_ANALYSIS_2026-08-29.md`: per-monolith canon needs, built/queued/missing setups, shared-library strategy, next-five execution order |
> | Fabric texture kit v0 (Faraway Mother + Mara gown) | **Done 2026-08-29 late** — `build_fabric_texture_kit.py`: 6 tileable textures (pleat detail normals ×2, seam mask, embroidery stitch atlases ×2, weave normal), 6/6 tile-check clean |
