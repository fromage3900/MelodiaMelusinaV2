...
void FMonolithBlueprintModule::StartupModule()
{
	...
	FMonolithBlueprintT3DActions::RegisterActions(Registry);
	...
	UE_LOG(LogMonolith, Log, TEXT("Monolith — Blueprint module loaded (112 actions + bulk_fill/describe adapter)"));
}
