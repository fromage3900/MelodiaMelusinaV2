    ...
    for v in variants:
        ...
        recipes.append({
            ...
            "params": {
                ...
                "texture_folder": f"{DEST_CYMA_ROOT}/{v}",
                "maps": {
                    "basecolor": str(vdir / f"T_Cymatic_{v}_BaseColor.png"),
                    "normal": str(vdir / f"T_Cymatic_{v}_Normal.png"),
                    "roughness": str(vdir / f"T_Cymatic_{v}_Roughness.png"),
                    "metallic": str(vdir / f"T_Cymatic_{v}_Metallic.png"),
                    "height": str(vdir / f"T_Cymatic_{v}_Height.png"),
                    "emissive": str(vdir / f"T_Cymatic_{v}_Emissive.png"),
                    "opacity": str(vdir / f"T_Cymatic_{v}_Opacity.png"),
                    "ao": str(vdir / f"T_Cymatic_{v}_ORM.png"),
                },
