...
# my-site-clean/generated/assets/ with organized naming.
...
$assetDir   = Join-Path $scriptRoot "my-site-clean\generated\assets"
...
Write-Host "  Target: my-site-clean/generated/assets/"
Write-Host ""
...
Write-Host ""
Write-Host "  [OK] $ingested files ingested into my-site-clean/generated/assets/"
Write-Host ""
