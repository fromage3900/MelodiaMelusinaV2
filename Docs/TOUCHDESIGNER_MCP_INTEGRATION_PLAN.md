...
**Installation target:** `C:\EnvironmentPortfolio\_TouchDesigner\` as the project root for Embody's `.mcp.json` generation.
...
3. [ ] Create `C:\EnvironmentPortfolio\_TouchDesigner\` directory
