...
| BP_ActionsUI | (4 BP_ActionButton children + ActionsBackground Image) | ?? **Missing ActionsBackground** — simplified widget tree |
...
| MelodiaNoteHighway Image | ? | ? **Missing** | ?? Difference |
...
|---|---|---|---|
| CanvasPanel_0 root | ? (render_opacity=0.92) | ? (render_opacity=1.0) | ?? Opacity differs |
...
| ActionsBackground Image | ? | ? **Missing** | ?? Stock has Background |
| ShowAnimation | ? | ? | ? |
